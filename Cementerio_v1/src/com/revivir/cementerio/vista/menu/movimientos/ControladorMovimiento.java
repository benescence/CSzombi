...
public class ControladorMovimiento implements  FallecidoSeleccionable {

	private VentanaTranslado ventana;
	private TransladoInvocable invocador;
	private Movimiento modificar;
	private Fallecido fallecido;
	
	
	public ControladorMovimiento(TransladoInvocable invocador, Movimiento modificar) {
	...
	public ControladorMovimiento(TransladoInvocable invocador) {
		this.invocador = invocador;
